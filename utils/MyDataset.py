...
class MyDataSet(Dataset):
    def __init__(self,data,args, tokenizer,mode='train'):
        self.df=data
        self.args = args
    ...
    def __getitem__(self,index):
        ...
        text_encode=self.encode.encode_plus(text, truncation=True,padding="max_length",max_length=max_length,return_tensors="pt")
